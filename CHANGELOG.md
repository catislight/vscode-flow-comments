...
### Changed
- Reverted mark syntax back to `// mark-<desc>` and aligned documentation and settings examples.
- Adjusted non-numbered title parsing: title token must start with a non-ASCII character to avoid conflicts with hyphenated sub-features.

### Features
- Tree groups hyphenated sub-features under the base feature and displays ordered steps hierarchically.
- Unordered steps across sub-features are merged and shown at the bottom of the base feature.


## [v0.3.3] - 2025-12-25

### Changed
- Updated extension logo and activity bar icon to SVG format.
